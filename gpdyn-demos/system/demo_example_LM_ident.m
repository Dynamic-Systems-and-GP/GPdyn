function [lm, Yeq] = demo_example_LM_ident(Ueq, dU, noiseStd, test_flag)
% demo_example_derivative - Partial derivatives obtained by identification
% of the demo nonlinear system in equilibrium points
%% Syntax
%  function [lm, Yeq] = demo_example_LM_ident(Ueq, dU, noiseStd, test_flag)
%
%% Description
...
%
% See Also
% demo_example.m, demo_example_derivative 
%
% Examples
...
if (test_flag>0)
    ...
    [dFdYanal dFdUanal Yanal Uanal] = demo_example_derivative(Ueq);
