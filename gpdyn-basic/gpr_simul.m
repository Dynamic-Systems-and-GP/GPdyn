function [out1, out2, out3, out4] = gpr_simul(logtheta, covfunc, x, y, xstar, alpha, L);

% gpr_simul - Gaussian process regression, with a named covariance function. Two
...
% must substract the noise variance. The rutine is modified to calculate the 
% inverse covariance matrix only once to speed-up simulation.
%
