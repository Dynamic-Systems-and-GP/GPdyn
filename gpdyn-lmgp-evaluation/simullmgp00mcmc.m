%% simullmgp00mcmc
function [mu, s2, MM, VV] = simullmgp00mcmc(logtheta, covfunc, input, target, targetvariance,...
    derivinput, derivtarget, derivvariance, xt, lag, Nsamples)

%% Syntax
%  [mu, s2, MM, VV] = simullmgp00mcmc(logtheta, covfunc, input, target, targetvariance,...
%     derivinput, derivtarget, derivvariance, xt, lag, Nsamples)
